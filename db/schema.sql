...
CREATE TABLE IF NOT EXISTS user_stats (
    ...
    double_kill INTEGER NOT NULL DEFAULT 0,  -- GP_CHDKILLC  (242) DOUBLEKILL
    triple_kill INTEGER NOT NULL DEFAULT 0,  -- GP_CHTKILLC  (244) TRIPLEKILL
    criticals   INTEGER NOT NULL DEFAULT 0,  -- GP_CHCRITICALC (362)
    multi_kill  INTEGER NOT NULL DEFAULT 0,  -- GP_CHMKILLC  (380) MULTIKILL
    ultra_kill  INTEGER NOT NULL DEFAULT 0,  -- GP_CHUKILLC  (382) ULTRAKILL
    z_kill      INTEGER NOT NULL DEFAULT 0,  -- GP_CHZKILLC  (384) GENOCIDE (see RESOURCES.md 5e)
    k_kill      INTEGER NOT NULL DEFAULT 0,  -- GP_CHKKILLC  (386) KILLINGMACHINE (see RESOURCES.md 5e)
    dd_kill     INTEGER NOT NULL DEFAULT 0,  -- GP_CHDDKILLC (388) DIABLO (see RESOURCES.md 5e)
