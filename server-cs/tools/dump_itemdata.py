...
Run from any working directory:
    python3 server-cs/tools/dump_itemdata.py                 # summary + band counts
    python3 server-cs/tools/dump_itemdata.py --name MP5K     # exact name lookup
    python3 server-cs/tools/dump_itemdata.py --id 12100027   # id lookup
    python3 server-cs/tools/dump_itemdata.py --band 12100000 # list one 100k band
