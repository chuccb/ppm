// =============================================================================
// GP_CHUKILLC_REQ (382) → GP_CHUKILLC_ACK (383)
...
{
    private static ValueTask GP_CHUKILLC_REQ(Session session, Packet packet, ServerContext context) =>
        UpdateGP_CH_CounterAsync(
            session,
            packet,
            context,
            Opcode.GP_CHUKILLC_ACK,
            "ultra_kill",
