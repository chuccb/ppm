...
{
    // 169 GR_RULECHANGE_REQ (sub_56F440): u8 modeIndex — 房主改遊戲模式
    // → 170 ACK (sub_56F4F0→sub_42FE50): u8 modeIndex — client 以 sub_53FBB0 重建
    //   mode UI 並以 sub_426930(modeIndex) 回推預設地圖寫 +130 (sub_540280)。
