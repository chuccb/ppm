...
public static class LoginWire
{
    ...
    /// <summary>Constructs the one-time login-listener greeting, GL_ACCOUNTCONNSUCC(694).</summary>
    public static Packet CreateAccountConnectionSuccess(ushort compressionThreshold) =>
        new Packet(Opcode.GL_ACCOUNTCONNSUCC).WriteU16(compressionThreshold);
