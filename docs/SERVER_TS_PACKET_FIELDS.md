...
| `sub_5929A0`、`sub_5929E0`（寫）；`sub_592A00`、`sub_5929C0`（讀） | 2 bytes | `u16`/`s16` | 681 channel/server counts、198 appearance 等再由 consumer 判斷 |
