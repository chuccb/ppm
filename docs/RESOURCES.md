...
即可定槽。已讀頁 3/16 chunks（Last-modified 2016-07-29）。
...
| 46 | Voice Shuffle2（中の人＝ガイ／檜山修之）| 同 04 之同文案換聲優 |
| 78 | Voice Shuffle3（中の人＝ドッドン／岡崎雅紘）| 同 04 |

**樣式指紋（語彙獨特、Wiki 對應表格行在尚未讀取之 chunk 3+）9 槽：**
23＝Magician（アシスタント、頼んだぞ／私たちのマジックをみせつけるぞ）、
27＝Wrestler（リングに飛びこめ！）、28＝Kung-Fu（アチョー！）、
47＝メカニカルウェア（装甲が持たない、援護を！）、65＝応援団
（押忍！団員全員で突撃！）、66＝Oshigoto（プレゼン資料がほしい…20歳）、
67＝Santa（トナカイがやられた！）、70＝バレンタイン（チョコをくれないかな？）、
71＝ひなまつり（お内裏である！）。

**占位槽：** 41、62–64、76–77、82–83、86、88–92（共 13 槽）全為字面
`ダミー／ダミー` 佔位；**87 號 XML 內跳缺**——（僅此一槽連標籤都不存在，原因 Unknown——Wiki 已讀名冊亦無對應線索）。

**判讀量統計：** hayate 92 槽＝已定名 34（15＋10＋9）＋ダミー 13＋跳缺 1
＋**未判讀 44 槽**（19–22、24–25、29–40、42–45、48–54、56–61、68–69、
72–75、79–81；Z1 全文已備份於工作底稿，待 Wiki chunk 3–16 其餘套名
——Band／Hunter／Dracula／Horror／貴族／Academy／Refine／俺様／スポーツ
／執事・メイド／男装＆女装／地球防衛軍…——做同法對位）。未判讀槽數多於
Wiki 已見套名數，暗示可能另有重錄版或未公開套（保留 Unknown）。
...
5. ~~sounds01/sounds80 聲包選取器；連殺語音 38 複本之軸~~ ✅ 2026-09-18
   ...
   26=イカ娘聯名、角色代號表）。**後續**：§11.6 槽↔套映射已解 34/92 槽、
   未判讀 44 槽——待讀完 Wiki ラジオチャット一覧 chunks 3–16（已讀 3 段）
   後以同法收尾；其餘 10 角色塊（tina…devilgirl）尚未做同法對位。
