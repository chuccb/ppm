...
```
wire[0]  基底 19,900,000  (套裝/特殊)      store this+158
wire[1]  基底 10,000,000  (主武器)         store this+159
wire[2]  基底 10,100,000  (副武器)         +160
wire[3]  基底 10,200,000  (近戰)           +161
wire[4]  基底 10,300,000  (投擲)           +162
wire[5]  基底 10,400,000  (頭部)           +163
wire[6]  基底 10,500,000  (臉部)           +164
wire[7]  基底 10,600,000  (上衣)           +165
wire[8]  基底 10,700,000  (下裝)           +166
wire[9]  基底 10,800,000  (手部)           +167
wire[10] 基底 10,900,000  (背部)           +168
wire[11] 基底 11,000,000  (特殊)           +169
```
(sub_5280F0 寫回時同公式驗證 sub_535020, 逐槽失敗碼 99/1/2...)
其他已定案的 id 區段:
- 15,300,007 (E975A7) = 戰隊常數; 15,300,032 (E975C0) = 205 特判 id
- 15,301,001..15,302,000 (i_36..E97D70) = 204/205 可購武器段 A
- 15,304,001..15,305,000 (E98541..E98928) = 房間武器顯示段
- 15,304,001..15,306,000 = 198 的 9×s32 裝備驗證段 (sub_522480)
- 15,310,001..15,320,000 (i_37..E9C3C0) = 可購段 B
- 11,010,001..11,070,000 = 快速槽 7×s32 驗證段 (sub_527AF0)
