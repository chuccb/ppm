...
| `server-cs/tools/gen_opcodes.py` | `db/packets.tsv` → `PaperMan.Protocol/Generated/Opcode.cs` | `Opcode.cs` 是 generated output；修改 opcode 名稱或值時由 source TSV / generator 處理，不手改 output。 |
