...
Run from any working directory:
    python3 tools/dump_maplist.py              # full catalog
    python3 tools/dump_maplist.py --mode 3     # maps playable in one modeIndex
    python3 tools/dump_maplist.py --id 89      # one map
    python3 tools/dump_maplist.py --check      # verify against the mode-bit table
...
# local source table mirrored in docs/RESOURCES.md section 4b.
