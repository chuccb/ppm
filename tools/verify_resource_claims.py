...
runs. Offline resource audit; it does not require the Bun server runtime.
"""
...
def main() -> None:
    ...
    # RESOURCES.md 5c-2d: each character voice pack is a complete 3x9 radio
    ...
    if not radio_names:
        ...
        for path in radio_files:
            pack = path.parents[1].parent.name
            character = path.parents[1].name.lower()
        ...
        check("character voice packs", len(grid), 15)
